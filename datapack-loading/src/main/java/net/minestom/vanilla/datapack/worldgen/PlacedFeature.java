...
public interface PlacedFeature {
    ...
    sealed interface PlacementModifier {
        ...
        @NamespaceTag("fixed_placement")
        record FixedPlacement(Config config) implements PlacementModifier {
            /**
             * @param positions List of positions to place on
             */
            public record Config(List<Integer> positions) {
            }
        }
    }
}